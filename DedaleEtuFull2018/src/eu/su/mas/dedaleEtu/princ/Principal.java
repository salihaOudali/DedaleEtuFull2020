...
//		c = containerList.get(ConfigurationFile.LOCAL_CONTAINER2_NAME);
//		Assert.assertNotNull("This container does not exist",c);
//		Object [] entityParameters2=new Object[] {params};
//		for(int i =0 ; i<agentNames.size();i++) {
//			ag=createNewDedaleAgent(c, agentNames.get(i), CollectorAgent.class.getName(), entityParameters2);
//			agentList.add(ag);
//		}
		...
		Object [] entityParameters2=new Object[] {params};
		for(int i =0 ; i<agentNames.size();i++) {
			ag=createNewDedaleAgent(c, agentNames.get(i), ExploreSoloAgent.class.getName(), entityParameters2);
			agentList.add(ag);
		}
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersC={params};
		...
		//3) If you want to give specific parameters to your agent, add them here
		Object [] entityParametersT={params};
